<%
 ...
 StandaloneScript = False ' set to TRUE if used as standalone script, set to FALSE when used with MultiRSS2HTML.asp
...
'''    For i = RSSItemsCount To 0 Step -1 ' use this line to show items in the reversed order
